...
export const metadata: Metadata = {
  ...
  description: "Build and deploy a custom AI chatbot in minutes with Nimmi AI. Train it on your data, integrate with WhatsApp & website. Trusted by Indian SMEs. Start free today.",
  alternates: {
