                ...
                <div className="hidden md:flex flex-col items-start space-y-8 p-8">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-4xl font-bold text-zinc-900 leading-tight">
                            Build chatbots that <span className="text-[#9d55ac]">feel human.</span>
                        </h2>
                        <p className="text-zinc-500 text-lg max-w-sm">
                            Join thousands of teams creating smarter, more engaging conversations with Nimmi AI.
                        </p>
                    </div>
                ...
                <div className="w-full max-w-md mx-auto">
                    <div className="bg-white border border-zinc-100 rounded-[2.5rem] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {error && (
                                <div className="bg-red-50 text-red-600 px-4 py-3 rounded-xl text-sm font-medium text-center animate-shake">
                                    {error}
                                </div>
                            )}
                        ...
                        <p className="text-center mt-8 text-zinc-500 font-medium">
                            ...
                            <Link href="/auth/signup" className="text-[#9d55ac] font-bold hover:underline decoration-2 underline-offset-4">
                                Sign Up
                            </Link>
                        </p>
                    </div>
