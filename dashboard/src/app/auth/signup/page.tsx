            ...
            <div className="w-full max-w-md z-10">
                <div className="bg-white/40 backdrop-blur-2xl border border-white/40 rounded-[2.5rem] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.05),inset_0_0_20px_rgba(255,255,255,0.5)] ring-1 ring-white/20">
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl font-bold bg-gradient-to-b from-zinc-900 to-zinc-600 bg-clip-text text-transparent">Create Account</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {error && (
                            <div className="bg-red-50/50 border border-red-100 text-red-600 px-4 py-3 rounded-xl text-sm font-medium text-center">
                                {error}
                            </div>
                        )}
